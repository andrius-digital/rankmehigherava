...
const positions: Position[] = [
  ...
  },
  {
    ...
    icon: BarChart3,
    color: "cyan",
    description: "Drive organic growth for local businesses. You'll run audits, optimize content, build backlinks, and get our clients ranking where they belong — at the top.",
    responsibilities: [
      "Perform technical SEO audits and implement fixes",
      "Optimize Google Business Profiles for local rankings",
      "Build high-quality backlinks and local citations",
      "Research keywords and create content strategies",
      "Track rankings and provide monthly performance reports",
    ],
    requirements: [
      "2+ years of SEO experience (local SEO preferred)",
      "Familiarity with tools like Ahrefs, SEMrush, or Moz",
      "Understanding of Google's ranking algorithms",
      "Experience with GBP optimization",
